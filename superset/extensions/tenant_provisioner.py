...
is invoked:
    ...
    TypeError: validate_contract_end_date() got an unexpected keyword
    argument 'data_key'
...
class TenantProvisioningSchema(Schema):
    ...
    # -----------------------------------------------------------------------
    # Validators — compatible with marshmallow 3 and 4.
    # -----------------------------------------------------------------------
    # marshmallow 4 passes data_key= as a keyword argument when calling
    # these methods.  The **kwargs absorbs it (and any future additions).
    # -----------------------------------------------------------------------
